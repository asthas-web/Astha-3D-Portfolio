...
const renderContent = {
  1: (
    <h1
      ...
      neo-brutalism-blue py-3 px-8 text-white mx-5"
    >
      Hi, I am <span className="font-semibold">Astha</span>👋
  ...
  4: (
    <InfoBox
      text="Need a project done or looking for a dev? I'am just a few
      keystrokes away"
      link="/contact"
      btnText="Let's talk"
    />
